...
Build a multi-layer neural network that will predict `body_mass` with the remaining predictors. 
...
::: {.fragment}
The error rate is a metric to determine how often will future data points be wrong when using our model.
:::
