...
-   **Python** is a general programming langauge that is available to download at: [python.org](https://www.python.org/)
    - Highly recommend using a python environment such as [uv](https://docs.astral.sh/uv/).
...
| 2    | Programming in R                                   |
| 3    | Neural Networks                                    |
| 4    | Layers, Optimizers, Loss, and Activation Functions |
| 5    | Recurrent Neural Networks                          |
| 6    | Convolutional Neural Networks                      |
| 7    | Tabular Data Analysis                              |
| --   | Spring Break                                       |
